...
model Furuta
 ...
 parameter Real pendulumFriction = 0.002;
  ...
  Modelica.Mechanics.MultiBody.Parts.BodyShape arm(
    ...
    m=0.165,
    I_11=0.00144)
    annotation (Placement(transformation(extent={{-18.0,16.0},{2.0,36.0}},rotation = 0.0,origin = {0.0,0.0})));
...
equation
  ...
  connect(armJoint.axis, armBearingFriction.flange_b)
                                                   annotation (Line(
      points={{-44,-14},{-50,-14},{-50,-10},{-72,-10}},
      color={0,0,0},
      smooth=Smooth.None));
  ...
  connect(armJoint.support, armBearingFriction.support)
                                                     annotation (Line(
      points={{-44,-20},{-62,-20},{-62,-20.000000000000004}},
      color={0,0,0},
      smooth=Smooth.None));
